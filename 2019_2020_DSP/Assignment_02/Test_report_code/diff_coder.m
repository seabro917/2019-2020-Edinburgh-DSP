...
% or columns of the original image is not integer multiple of 8(e.g.spine.jpg).
...
% ------Zero padding operation, if no zero padding is needed, then the
...
for n = 1:num_of_block_total
    ...
    %     Create the mean image based on the calculated mean value of each
    %     block.
...
% Function for calculating the mean for a 8*8 block.
