...
% Convert it to double for later on calculation.
...
for n = 1:num_of_block_total
   ...
   diff_image(8*(index_row-1)+1:8*index_row, 8*(index_column-1)+1:8*index_column) = idct_88(block_temp);
end
