...
% Get the mean image back to the size of original image, 
...
% scale the gray value range of diff_image to 0 to 255.
...
% Quantize this vectorized diff image, this is what we will encode.
